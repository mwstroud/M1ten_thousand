...
from connectors import (one_to_one, one_to_one_offset, syn_dist_delay_feng_section, syn_uniform_delay_section,
                        syn_percent_o2a,syn_percent, recurrent_connector_o2a,perc_conn,sphere_dropoff,section_id_placement,cs2cp_gaussian_cylinder)
...
pos_list_5A[:,2] = pos_list_5A[:,2]*(600 - 300) + 300
...
pos_list_5B[:,2] = pos_list_5B[:,2]*(300-0) + 0
...
if edge_effects: # When enabled, a shell of virtual cells will be created around the core network.
    ...
    virt_pos_list_5A[:,2] = virt_pos_list_5A[:,2]*(600) + 300
    ...
    virt_pos_list_5B[:,2] = virt_pos_list_5B[:,2]*(600) - 300
...
edge_params = {
    'FSI2FSI_uni': {
        ...
        'connection_params':{'p':0.34, 'track_list':FSI_FSI_list},
        'syn_weight':1,
    ...
    'FSI2CS_uni': {
        'iterator':'one_to_all',
        'connection_rule':syn_percent_o2a,
        'connection_params':{'p':0.17,'track_list':FSI_CP_list},
        'syn_weight':1,
    ...
    'FSI2LTS_uni': {
        'iterator':'one_to_all',
        'connection_rule':syn_percent_o2a,
        'connection_params':{'p':0.34,'track_list':FSI_LTS_list},
        'syn_weight':1,
    ...
    'LTS2LTS_uni': {
        'iterator':'one_to_all',
        'connection_rule':syn_percent_o2a,
        'connection_params':{'p':0.034, 'track_list':LTS_LTS_list},
        'syn_weight':1,
    ...
    'LTS2CP_uni': {
        'iterator':'one_to_all',
        'connection_rule':syn_percent_o2a,
        'connection_params':{'p':0.35,'track_list':LTS_CP_list},
        'syn_weight':1,
        'dynamics_params':'LTS2PN_noSTP.json',
        'distance_range':[min_conn_dist,max_conn_dist],
        'target_sections': ['dend']
    },
    'LTS2CP_rec': {
    ...
    'LTS2FSI_uni': {
        'iterator':'one_to_all',
        'connection_rule':syn_percent_o2a,
        'connection_params':{'p':0.53,'track_list':LTS_FSI_list},
        'syn_weight':1,
    ...
    'CP2LTS': {
        'iterator':'one_to_all',
        'connection_rule':syn_percent_o2a,
        'connection_params':{'p':0.57, 'track_list':CP_LTS_list},
        'syn_weight':1,
    ...
    'CS2LTS': {
        'iterator':'one_to_all',
        'connection_rule':syn_percent_o2a,
        'connection_params':{'p':0.57, 'track_list':CS_LTS_list},
        'syn_weight':1,
        'dynamics_params':'PN2LTS.json',
        'distance_range':[min_conn_dist,max_conn_dist],
        'target_sections': ['dend']
